...
describe('Konut Kredisi Hesaplama', () => {
  ...
  it('should handle 0% interest safely', () => {
    ...
    const res = calculateMortgageLoan(100000, 0, 12);
  ...
  it('should handle 1 month term', () => {
    ...
    const res = calculateMortgageLoan(100000, 2, 1);
