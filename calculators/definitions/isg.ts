...
export const isgCalculatorDef: CalculatorDefinition<Input, any> = {
  ...
  type: 'complex',
  metadata: {
    title: 'İSG Puan Hesaplama — İş Sağlığı ve Güvenliği Uzmanlık Sınavı | Hesapera',
  ...
  fields: [
    {
      ...
      required: true,
      options: [
        { label: 'Sınıf A — Çok Tehlikeli (Geçme: 75)', value: 'A' },
        { label: 'Sınıf B — Tehlikeli (Geçme: 70)', value: 'B' },
        { label: 'Sınıf C — Az Tehlikeli (Geçme: 70)', value: 'C' }
      ]
    },
