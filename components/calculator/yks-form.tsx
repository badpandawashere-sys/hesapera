        ...
        <div className="flex-1 space-y-8">
          ...
          <div className="bg-slate-50 p-4 rounded-2xl border flex flex-col sm:flex-row sm:items-center gap-4">
            <div className="flex-1 space-y-2">
              ...
              <input type="text" inputMode="decimal" min="50" max="100" value={inputs.diplomaNotu||''} onChange={e=>setInputs(p=>({...p, diplomaNotu: Number(e.target.value)}))} className="w-full px-4 py-2 border rounded-xl font-bold" />
            </div>
